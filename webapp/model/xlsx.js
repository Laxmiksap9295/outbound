jQuery.sap.require("LoadingConfirmation.model.jszip");
var XLSX = {};
(function make_xlsx(XLSX) {
	...
	var make_ssf = function make_ssf(SSF) {
		...
		var table_fmt = {
			...
			48: '##0.0E+0',
			49: '@',
			56: '"Ã¤Â¸Å Ã¥ÂË†/Ã¤Â¸â€¹Ã¥ÂË† "hh"Ã¦â„¢â€š"mm"Ã¥Ë†â€ "ss"Ã§Â§â€™ "',
			65535: 'General'
		};
		var days = [
			['Sun', 'Sunday'],
	...
	function write_theme() {
		...
		o[o.length] = '<a:font script="Jpan" typeface="Ã¯Â¼Â­Ã¯Â¼Â³ Ã¯Â¼Â°Ã£â€šÂ´Ã£â€šÂ·Ã£Æ’Æ’Ã£â€šÂ¯"/>';
		o[o.length] = '<a:font script="Hang" typeface="Ã«Â§â€˜Ã¬Ââ‚¬ ÃªÂ³ Ã«â€â€¢"/>';
		o[o.length] = '<a:font script="Hans" typeface="Ã¥Â®â€¹Ã¤Â½â€œ"/>';
		o[o.length] = '<a:font script="Hant" typeface="Ã¦â€“Â°Ã§Â´Â°Ã¦ËœÅ½Ã©Â«â€"/>';
	...
	var parse_content_xml = (function() {
		...
		return function pcx(d, _opts) {
			...
			while ((Rn = xlmlregex.exec(str))) switch ((Rn[3] = Rn[3].replace(/_.*$/, ""))) {
				...
				case 'table':
				case 'Ã¥Â·Â¥Ã¤Â½Å“Ã¨Â¡Â¨': // 9.1.2 <table:table>
					if (Rn[1] === '/') {
						if (range.e.c >= range.s.c && range.e.r >= range.s.r) ws['!ref'] = encode_range(range);
						if (merges.length) ws['!merges'] = merges;
						sheetag.name = utf8read(sheetag['Ã¥ÂÂÃ§Â§Â°'] || sheetag.name);
				...
				case 'table-row':
				case 'Ã¨Â¡Å’': // 9.1.3 <table:table-row>
					if (Rn[1] === '/') break;
					rowtag = parsexmltag(Rn[0], false);
					if (rowtag['Ã¨Â¡Å’Ã¥ÂÂ·']) R = rowtag['Ã¨Â¡Å’Ã¥ÂÂ·'] - 1;
					else ++R;
					C = -1;
					break;
				...
				case 'Ã¦â€¢Â°Ã¦ÂÂ®':
					if (Rn[0].charAt(Rn[0].length - 2) === '/') {
						...
						ctag = parsexmltag(Rn[0], false);
						q = ({
							t: ctag['Ã¦â€¢Â°Ã¦ÂÂ®Ã§Â±Â»Ã¥Å¾â€¹'] || ctag['value-type'],
							v: null
						});
						if (opts.cellFormula) {
						...
						switch (q.t) {
							...
							case 'number':
								q.t = 'n';
								q.v = parseFloat(ctag['Ã¦â€¢Â°Ã¦ÂÂ®Ã¦â€¢Â°Ã¥â‚¬Â¼']);
								break;
							default:
				...
				case 'Ã§â€ÂµÃ¥Â­ÂÃ¨Â¡Â¨Ã¦ Â¼Ã¦â€“â€¡Ã¦Â¡Â£': // 3.1.3.2 <office:document-content>
				case 'spreadsheet':
				case 'Ã¤Â¸Â»Ã¤Â½â€œ': // 3.7 <office:spreadsheet>
				...
				case 'font-face-decls': // 3.14 <office:font-face-decls>
					...
					/* ignore state */
				case 'meta':
				case 'Ã¥â€¦Æ’Ã¦â€¢Â°Ã¦ÂÂ®': // TODO: <office:meta> <uof:Ã¥â€¦Æ’Ã¦â€¢Â°Ã¦ÂÂ®> FODS/UOF
